...
> * Timeline: Feb 2, 2026 – June 30, 2026.
...
> * Mode Selection (Two distinct sections/cards): Card A: "Targeted Practice" (Input Field: "Enter a topic", Button: "Ask Me Anything" triggers generateInterviewQuestion). Card B: "Review My Work" (Text: "Test your knowledge on your completed tasks.", Button: "Surprise Me 🎲" triggers getRandomGoalTopic -> then generateInterviewQuestion).
